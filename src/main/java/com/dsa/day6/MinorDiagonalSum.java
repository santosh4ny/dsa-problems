...
Explanation 2:
 ...
 A[1][2] + A[2][1] = 2 + 2 = 4
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Minor Diagonal sum : "+ minorDiagonalSum(arr));
        System.out.println("Minor Diagonal sum : "+ minorDiagonalSum(arr1));
    }
    private static int minorDiagonalSum(int[][] arr){
        int sum = 0;
        int len = arr.length;
