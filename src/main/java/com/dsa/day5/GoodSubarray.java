...
There are 36 good subarrays
    ...
    public static void main(String[] args) {
        int[] nums = {1, 2, 3, 4, 5};
        int b = 4;
        int[] nums1 = {13, 16, 16, 15, 9, 16, 2, 7, 6, 17, 3, 9};
        int b1 = 65;

        System.out.println("First good array is : "+goodSubarray(nums, b));
        System.out.println("Second good array is : "+goodSubarray(nums1, b1));
    }
    private static int goodSubarray(int[] nums, int b){
        int ans = 0;
        int n = nums.length;
        for(int i=0; i<n; i++){
            int sum = 0;
