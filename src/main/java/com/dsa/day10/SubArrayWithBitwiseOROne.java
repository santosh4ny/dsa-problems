...
public class SubArrayWithBitwiseOROne {
    /*
Problem Description
...
Except the subarray [0] all the other subarrays has a Bitwise OR = 1
    ...
    public static void main(String[] args) {
        int[] arr = {1, 0, 1};
        int len = 3;
        System.out.println("Total Sub array with zero count : "+subArrayWithBitwiseOr(arr, len));
    }
    private static long subArrayWithBitwiseOr(int[] arr, int len){
        long totalSubArray = (len * (len+1))/ 2;
        ...
        return totalSubArray - zeroSubArrayCount;
    }
}
